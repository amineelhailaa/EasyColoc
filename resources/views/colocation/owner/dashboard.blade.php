...
@section('content')
    ...
    <div data-dashboard-scroll-root class="owner-dashboard-font w-full space-y-5 overflow-x-hidden">
            ...
            <div class="space-y-6">
                ...
                <section class="rounded-2xl border border-cerulean-200 bg-white p-5 shadow-sm md:p-6">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <span class="rounded-full border border-cerulean-300 bg-white/80 px-2.5 py-1 text-xs font-semibold text-cerulean-700">
                            Daily • 30 days
                        </span>
                    </div>
        ...
        <section id="global-dashboard-expenses" class="rounded-2xl border border-cerulean-200 bg-white p-5 shadow-sm md:p-6">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <form action="{{ route('owner.dashboard') }}" method="get" class="flex flex-wrap items-center gap-2">
                        ...
                        @if(request('month') && request('year'))
                            <a href="{{ route('owner.dashboard') }}" class="rounded-md border border-cerulean-300 bg-white px-2.5 py-1 text-[11px] font-semibold text-cerulean-700 hover:bg-cerulean-100">
                                Clear
                            </a>
                        @endif
                    </form>
            ...
            <div class="mt-5 hidden rounded-xl border border-cerulean-200 bg-white md:block overflow-hidden">
                <div class=" ">
                                ...
                                <tr class="bg-white transition hover:bg-cerulean-50/60">
                                    ...
                                    <td class="px-4 py-3 text-cerulean-700">
                                        <div class="relative inline-flex items-center">
                                            ...
                                            <template data-participants-template>
    ...
    <div id="participants-tooltip-portal" class="pointer-events-none fixed left-0 top-0 z-[70] hidden w-56 rounded-lg border border-cerulean-200 bg-white p-2 shadow-xl"></div>
    ...
    <script>
        (() => {
            const portal = document.getElementById('participants-tooltip-portal');
            if (!portal) {
                return;
            }
            ...
            const showPortal = (trigger) => {
                const template = trigger.parentElement?.querySelector('template[data-participants-template]');
                if (!template) {
                    return;
                }
